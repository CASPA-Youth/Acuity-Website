// Central place for event facts so they stay consistent across the site.
...
export const event = {
  ...
  description:
    'Join online or in Santa Clara, meet your team, and build an original project around a theme revealed when the hackathon begins.',
